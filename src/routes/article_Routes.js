...
router.post('/create-article', uploadImage.single("article_img"), article_Controller.add_Article)
...
router.post('/update-article/:id', uploadImage.single("article_img"), article_Controller.update_Article)
